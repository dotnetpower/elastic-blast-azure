...
> Generated: 2026-03-15 04:04 UTC
> Region: koreacentral
...
| ---- | ------- | ----- | --------- | -------- | ------ |
| A1 | blob_nfs | cold | 434.2 | 0.24 | success |
| A2 | warm | warm | 426.9 | 0.24 | success |

**Warm cluster savings**: 2% (434s -> 427s)

## 5. All Results Summary

| Test | Dataset | VM | Nodes | Storage | Total (s) | Cost ($) | Status |
| ---- | ------- | -- | ----- | ------- | --------- | -------- | ------ |
| A1 | small | Standard_E32s_v3 | 1 | blob_nfs | 434.2 | 0.24 | success |
| A2 | small | Standard_E32s_v3 | 1 | warm | 426.9 | 0.24 | success |
