...
def check_for_read(fname: str, dry_run : bool = False, print_file_size: bool = False,
                   gcp_prj: str | None = None, sas_token: Optional[str] = None) -> None:
...
def get_length(fname: str, dry_run: bool = False, gcp_prj: str | None = None, sas_token: Optional[str] = None) -> int:
...
def open_for_read(fname: str, gcp_prj: str | None = None, sas_token: Optional[str] = None):
...
def open_for_read_iter(fnames: Iterable[str], gcp_prj: str | None = None, sas_token: Optional[str] = None) -> Generator[TextIO, None, None]:
