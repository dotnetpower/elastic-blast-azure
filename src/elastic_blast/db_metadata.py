...
def get_db_metadata(db: str, dbtype: MolType, source: DBSource, dry_run: bool = False, gcp_prj: str | None = None, azure_storage_account_endpoint: Optional[str] = None, sas_token: Optional[str] = None) -> DbMetadata:
    """
